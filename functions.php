...
function infinite_photography_setup() {
	 ...
	 * If you're building a theme based on Infinite Photography, use a find and replace
	 * to change 'infinite-photography' to the name of your theme in all the template files.
	 */
 ...
 */
function infinite_photography_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'infinite-photography' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'infinite_photography_widgets_init' );
...
function infinite_photography_scripts() {
	...
	wp_enqueue_script( 'infinite-photography-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'infinite-photography-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
